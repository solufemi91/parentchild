...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { first_name: @child.first_name, mother_id: @child.mother_id } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { first_name: @child.first_name, mother_id: @child.mother_id } }
